...
// Generated by tidyxmlcfg.pl 2015/05/28 17:19:38 UTC, 19:19:38 local
// code to be added
...
void MarkupTab::on_css_prefixEd()
{
...
void MarkupTab::on_new_inline_tagsEd()
{
...
void MarkupTab::on_new_blocklevel_tagsEd()
{
...
void MarkupTab::on_new_empty_tagsEd()
{
...
void MarkupTab::on_new_pre_tagsEd()
{
...
static LABEL label[] = {
    ...
    { css_prefix, "css-prefix", "String", "markup" },
    { new_inline_tags, "new-inline-tags", "Tag names", "markup" },
    { new_blocklevel_tags, "new-blocklevel-tags", "Tag names", "markup" },
    { new_empty_tags, "new-empty-tags", "Tag names", "markup" },
    { new_pre_tags, "new-pre-tags", "Tag names", "markup" },
...
static LINED lined[] = {
    ...
    { css_prefixEd, "css-prefix", "String", "markup" },
    { new_inline_tagsEd, "new-inline-tags", "Tag names", "markup" },
    { new_blocklevel_tagsEd, "new-blocklevel-tags", "Tag names", "markup" },
    { new_empty_tagsEd, "new-empty-tags", "Tag names", "markup" },
    { new_pre_tagsEd, "new-pre-tags", "Tag names", "markup" },
